...
7. OBS! Vores program virker kun med iphone telefoner i denne version da den kun kan sync med apple-calender 
...
Så er du i gang! Resten af detaljerne (fx hvilke nøgler der skal bruges) finder du i rapporten.
